...
Int_Main:
 ...
 movlw 0x0
 movwf int_count, A
 bsf ((INTCON) and 0FFh), 5, a
 bsf ((RCON) and 0FFh), 7, a
 bsf ((INTCON) and 0FFh), 7, a ; Enable all interrupts
 pop
 pop
...
Int_Main_lt10:
 ...
 pop
 pop
 goto Analysis_and_output

Int_Check:
 movlw 0x0F ; if int_count isn't 10, post increment FSR0
 cpfseq int_count, A
 goto Int_return
 movlw 0x01 ; if int_count i 10 set the initialise variable
 movwf init, A
 lfsr 0, 0x080 ; Point FSR0 to begining of data block in RAM
 movlw 0x0 ; reset the int_count
 movwf int_count, A
 bsf ((INTCON) and 0FFh), 7, a ; Enable all interrupts
 bsf ((INTCON) and 0FFh), 5, a ; Enable TMR0 interrupt
 pop
 pop
 goto Analysis_and_output

Int_return:
 movf POSTINC0, W, A ; Post increment FSR0
 retfie f ; return to main loop
 end
