...
# 1490 "C:\\Program Files\\Microchip\\xc8\\v2.30\\pic\\include\\pic18_chip_select.inc" 3
# 1 "C:\\Program Files\\Microchip\\xc8\\v2.30\\pic\\include\\proc\\pic18f87k22.inc" 1 3
# 48 "C:\\Program Files\\Microchip\\xc8\\v2.30\\pic\\include\\proc\\pic18f87k22.inc" 3
PMD3 equ 0F16h
...
TOSU equ 0FFFh
# 12494 "C:\\Program Files\\Microchip\\xc8\\v2.30\\pic\\include\\proc\\pic18f87k22.inc" 3
...
# 1490 "C:\\Program Files\\Microchip\\xc8\\v2.30\\pic\\include\\pic18_chip_select.inc" 2 3
...
global LCD_Setup, LCD_Write_HR, LCD_ErrMessage
extrn numresulth, numresultl, count_beats
...
LCD_Write_Hex_HB: ; Writes byte stored in W as hex
 movwf LCD_hex_tmp, A
 swapf LCD_hex_tmp, W, A ; high nibble first
 call LCD_Hex_Nib_HB
 movf LCD_hex_tmp, W, A ; then low nibble
LCD_Hex_Nib_HB: ; writes low nibble as hex character
 andlw 0x0F ; if there is a 0 that appears in the high byte
 movwf LCD_tmp, A ; do not write it
 movlw 0x0
 cpfsgt LCD_tmp, A
 return
 movlw 0x0A
...
LCD_Write_Hex_LB: ; Writes byte stored in W as hex
 movwf LCD_hex_tmp, A
 swapf LCD_hex_tmp, W, A ; high nibble first
 call LCD_Hex_Nib_LB
 movf LCD_hex_tmp, W, A ; then low nibble
LCD_Hex_Nib_LB: ; writes low nibble as hex character
 andlw 0x0F
 movwf LCD_tmp, A
 movlw 0x0A
 cpfslt LCD_tmp, A
...
LCD_Write_HR:
 ...
 movlw ' '
 call LCD_Send_Byte_D ; write out ascii
 movf numresulth, W, A ;move HR high byte to W
 call LCD_Write_Hex_HB ;write to LCD
 movf numresultl, W, A ;move HR low byte to W
 call LCD_Write_Hex_LB ;write to LCD
 return

LCD_ErrMessage: ; print message '   Adjust Fit'
 call LCD_Clear
 movlw ' '
